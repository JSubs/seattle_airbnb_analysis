...
Download and install Tableau Desktop
 (or Tableau Public if you prefer a free version).

3. Open the project

Locate and open the file SeattleAirbnb.twbx in Tableau.

The dashboard will load automatically.

4. (Optional) Update data source

If you are using a local dataset:

Go to Data → Edit Connection and update the file path to your dataset.
...
The dataset is sourced from Inside Airbnb
 — a public dataset providing detailed Airbnb listing information.

🧑‍💻 Author

Jonathan Subit
Jonathanmatthewsubit@gmail.com
www.linkedin.com/in/jonathan-subit
